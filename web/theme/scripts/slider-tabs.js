...
(function( $ ){
    ...
    $.sliderTabs = function(container, options){
        ...
        plugin.init = function(){
            ...
            $('.diagnostic-section-1').on('click', function setHeightOne() {
                $('.diagnostic .ui-slider-tabs-content-container').height($('#diagnostic-1').height());

                for (i = 1000; i < 1002; i++) {
                    var timerOne = setInterval(setHeightOne, i);

                    clearInterval(timerOne);
                }
            });

            $('.diagnostic-section-2').on('click', function setHeightTwo() {
                $('.therapy .ui-slider-tabs-content-container').height($('#therapy-1').height());

                for (i = 1000; i < 1002; i++) {
                    var timerTwo = setInterval(setHeightTwo, i);
        ...
        plugin.slideTabs = function(direction, length){
            ...
            if(direction=='right') newMargin += length + 350;
            else if(direction=='left') newMargin -= length + 350;
